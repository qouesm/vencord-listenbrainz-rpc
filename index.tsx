...
export default definePlugin({
    ...
    settingsAboutComponent: () => (
        <>
            ...
            <Forms.FormText>
                The MusicBrainz API does not require an API key, but it does require
                a <Link href="https://musicbrainz.org/doc/MusicBrainz_API/Rate_Limiting#Provide_meaningful_User-Agent_strings"> meaningful user-agent string</Link> .
